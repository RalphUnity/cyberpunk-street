...
namespace UnityEngine.Recorder.Examples
{
    ...
    public class MultipleRecordingsExample : MonoBehaviour
    {
       ...
       void OnEnable()
       {
           ...
           var mediaOutputFolder = System.IO.Path.Combine(Application.dataPath, "..", "SampleRecordings");
           // animation output is an asset that must be created in Assets folder
           var animationOutputFolder = System.IO.Path.Combine(Application.dataPath, "SampleRecordings");
           ...
           videoRecorder.outputFile = System.IO.Path.Combine(mediaOutputFolder, "video_v" + DefaultWildcard.Take);
           ...
           animationRecorder.outputFile = System.IO.Path.Combine(animationOutputFolder, "anim_" + DefaultWildcard.GeneratePattern("GameObject") + "_v" + DefaultWildcard.Take);
           ...
           imageRecorder.outputFile = System.IO.Path.Combine(mediaOutputFolder, "_png", "image_v" + DefaultWildcard.Take + "." + DefaultWildcard.Frame);
